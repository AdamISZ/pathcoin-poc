...
Must be run concurrently with all other participants.
Arguments: my-index [, funding-utxo-str]
The last argument is only used by the first participant (the funder).

Example usage:
python runme.py presign 2
or
python runme.py presign 0 "72c2f842ff7c5c62eba2e3072ca87d33b6f17374f02166f5c70497ca7b4c5e1c:0"
"""
...
Arguments: my-index, filename-of-transfer-file

Example usage:
python runme.py receive 2 pathcoinstate1.transfer
...
Arguments: my-index, utxo-string-of-fidelity-bond, payout-address

Example usage:

python runme.py reclaim 0 "72c2f842ff7c5c62eba2e3072ca87d33b6f17374f02166f5c70497ca7b4c5e1c:0" bcrt1q..
"""

help_strings["penalty"] = """
Claims another participant's fidelity bond after they illegally
spend the pathcoin.
Arguments: my-index, index-of-participant-claiming-from,
utxo-string-of-fidelity-bond, our-payout-address,
full-transaction-hex-of-illegal-spend

Example usage:
./runme.py penalty 1 0 "e2....8d:0" bcrt1q... "02000000000101..."
